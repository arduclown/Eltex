...
int main(){
	...
	while (1){
		...
		case 1: {
			...
			if (addContact(&contacts, &contactCount, lastName, firstName, surname, workplace,
        ...
        case 2: {
            ...
            if (editeContact(&contacts, &contactCount, id, lastName, firstName, surname,
        ...
        case 3: {
            ...
            if (deleteContact(&contacts, &contactCount, id) == 0)
        ...
        case 4: {
            if (saveContactBook(contacts, contactCount, filename) == 0)
        ...
        case 5: {
            if (readContactBook(&contacts, &contactCount, filename) == 0)
        ...
        case 6: {
            ...
            printContactBook(contacts, contactCount, output, sizeof(output));
            printf("%s", output);
            break;
        }
        case 7: {
